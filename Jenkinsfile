  ...
  stages {
    ...
    steps {
        ...
        withEnv([
            ...
            docker build -t arunchaitanya93/movie-streaming-backend-nodejs:latest .
            docker push arunchaitanya93/movie-streaming-backend-nodejs:latest
            docker build -t arunchaitanya93/movie-streaming-frontend:latest ./html
            docker push arunchaitanya93/movie-streaming-frontend:latest
            docker logout
            '''
        }
        }
